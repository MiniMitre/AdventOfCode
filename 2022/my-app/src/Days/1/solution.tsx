  ...
  return (
    <div className="container">
      ...
      <div className="part-1-calculation day1">
        <h3>Calculation:</h3>
        <p>
          <strong>Elf 1:</strong> 6,000
        </p>
        <p>
          <strong>Elf 2:</strong> 4,000
        </p>
        <p>
          <strong>Elf 3:</strong> 11,000
        </p>
        <p>
          <strong>Elf 4:</strong> <span className="green">24,000</span>
        </p>
        <p>
          <strong>Elf 5:</strong> 10,000
        </p>
      </div>
      ...
      <div className="part-2-calculation day1">
        ...
        <p>
          <strong>Elf 3:</strong> <span className="green">11,000</span>
        </p>
        <p>
          <strong>Elf 4:</strong> <span className="green">24,000</span>
        </p>
        <p>
          <strong>Elf 5:</strong> <span className="green">10,000</span>
        </p>
      </div>
