  ...
  return(
    ...
    <div className="container">
      ...
      <div className="part-1-calculation">
        <h3>Calculation:</h3>
        <p><strong>1{`)`}</strong> Paper beats Rock</p>
        <p>2 + 6 = <strong className="green">8</strong></p>
        <p><strong>2{`)`}</strong> Rock loses to Paper</p>
        <p>1 + 0 = <strong className="green">1</strong></p>
        <p><strong>3{`)`}</strong> Scissors draw</p>
        <p>3 + 3 = <strong className="green">6</strong></p>
      </div>
      ...
      <div className="part-2-calculation">
        <h3>Calculation:</h3>
        <p><strong>1{`)`}</strong> Rock draw</p>
        <p>1 + 3 = <strong className="green">4</strong></p>
        <p><strong>2{`)`}</strong> Rock loses to Paper</p>
        <p>1 + 0 = <strong className="green">1</strong></p>
        <p><strong>3{`)`}</strong> Rock bests Scissors</p>
        <p>1 + 6 = <strong className="green">7</strong></p>
      </div>
